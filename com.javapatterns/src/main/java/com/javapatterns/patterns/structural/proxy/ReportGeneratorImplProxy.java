...
/**
 * 
 * Proxy portion of the proxy pattern.
 *
 */
public class ReportGeneratorImplProxy implements ReportGenerator {
	...
	public void displayReportTemplate(String reportFormat, int reportEntries) {
		System.out.println("ReportGeneratorImplProxy: Displaying blank report " +
				"template in " + reportFormat + " format with " + reportEntries + " entries");
	...
	public void generateSensitiveReport() {
		if(accessRole.getRole().equals("Manager")) {
			...
			System.out.println("You are not authorized to access sensitve reports.");
		}
